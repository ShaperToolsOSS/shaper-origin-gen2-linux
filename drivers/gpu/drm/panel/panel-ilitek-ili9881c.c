...
/* old davis 5.10 command sequence */
static const struct ili9881c_instr legacy_davis_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(3),
	ILI9881C_COMMAND_INSTR(0x01,0x00),
	ILI9881C_COMMAND_INSTR(0x02,0x00),
	...
	ILI9881C_COMMAND_INSTR(0x7D,0x06), /* GIP=VGL @ sleep out sequence */
	ILI9881C_COMMAND_INSTR(0x7E,0x02),
	ILI9881C_COMMAND_INSTR(0x7F,0x02),
	...
	ILI9881C_COMMAND_INSTR(0x6C,0x15),
	ILI9881C_COMMAND_INSTR(0x6E,0x2A), /* 3B=18.06V 2A=15V */
	ILI9881C_COMMAND_INSTR(0x6F,0x33), /* 43 VGH=16V VGL=-10V FLIC=16.8 AVDD=5.38 AVEE=-5.19V */
	ILI9881C_COMMAND_INSTR(0x3A,0x94),
	ILI9881C_COMMAND_INSTR(0x8D,0x1A), /* 1A */
	ILI9881C_COMMAND_INSTR(0x87,0xBA),
	ILI9881C_COMMAND_INSTR(0x26,0x76),
	ILI9881C_COMMAND_INSTR(0xB2,0xD1),
	...
	ILI9881C_COMMAND_INSTR(0x53,0x8F), /* VCOM1 */
	ILI9881C_COMMAND_INSTR(0x55,0x8F), /* VCOM2 */
	ILI9881C_COMMAND_INSTR(0x50,0xAE), /* VREG1OUT C8=5.1V  A6=4.7 96=4.5V */
	ILI9881C_COMMAND_INSTR(0x51,0xAE), /* VREG2OUT C8=-5.1V A6=4.7 96=4.5V */
	ILI9881C_COMMAND_INSTR(0x60,0x28), /* SDT  08 */
	ILI9881C_COMMAND_INSTR(0x63,0x00),
	ILI9881C_COMMAND_INSTR(0xA0,0x0F), /* VP255 Gamma P */
	ILI9881C_COMMAND_INSTR(0xA1,0x21), /* VP251 */
	ILI9881C_COMMAND_INSTR(0xA2,0x2F), /* VP247 */
	ILI9881C_COMMAND_INSTR(0xA3,0x14), /* VP243 */
	ILI9881C_COMMAND_INSTR(0xA4,0x17), /* VP239 */
	ILI9881C_COMMAND_INSTR(0xA5,0x29), /* VP231 */
	ILI9881C_COMMAND_INSTR(0xA6,0x1E), /* VP219 */
	ILI9881C_COMMAND_INSTR(0xA7,0x1F), /* VP203 */
	...
	ILI9881C_COMMAND_INSTR(0xB2,0x58), /* VP4 */
	ILI9881C_COMMAND_INSTR(0xB3,0x3F), /* VP0 */
	ILI9881C_COMMAND_INSTR(0xC0,0x04), /* VN255 GAMMA N */
	ILI9881C_COMMAND_INSTR(0xC1,0x22), /* VN251 */
	ILI9881C_COMMAND_INSTR(0xC2,0x30), /* VN247 */
	ILI9881C_COMMAND_INSTR(0xC3,0x14), /* VN243 */
	ILI9881C_COMMAND_INSTR(0xC4,0x17), /* VN239 */
	ILI9881C_COMMAND_INSTR(0xC5,0x2A), /* VN231 */
	ILI9881C_COMMAND_INSTR(0xC6,0x1E), /* VN219 */
	ILI9881C_COMMAND_INSTR(0xC7,0x1E), /* VN203 */
	ILI9881C_COMMAND_INSTR(0xC8,0x8A), /* VN175 */
	ILI9881C_COMMAND_INSTR(0xC9,0x1B), /* VN144 */
	ILI9881C_COMMAND_INSTR(0xCA,0x28), /* VN111 */
	ILI9881C_COMMAND_INSTR(0xCB,0x74), /* VN80 */
	ILI9881C_COMMAND_INSTR(0xCC,0x1C), /* VN52 */
	...
	ILI9881C_COMMAND_INSTR(0xD2,0x58), /* VN4 */
	ILI9881C_COMMAND_INSTR(0xD3,0x3F), /* VN0 */
};

/* forked off kd050hdfia020_init */
static const struct ili9881c_instr davis_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(3),
	ILI9881C_COMMAND_INSTR(0x01, 0x00),
	ILI9881C_COMMAND_INSTR(0x02, 0x00),
	ILI9881C_COMMAND_INSTR(0x03, 0x72),
...
static int ili9881c_enable(struct drm_panel *panel)
{
	...
	/* Reference 15.2 Internal VGH Programming Flow (Fig. 109) in ILI9881C datasheet (V095) */
	msleep(20);
...
static const struct drm_display_mode davis_default_mode = {
        .clock          = 74300,                         /* 720p60 nominal pixel clock; with larger blanking this runs ~53.4 Hz */

        .hdisplay       = 720,                           /* = Horizontal Active (720) */
        .hsync_start    = 720 + 120,                      /* = Horizontal Active + HFPD (720 + 120) */
        .hsync_end      = 720 + 120 + 20,                 /* = Horizontal Active + HFPD + HSPW (720 + 120 + 20) */
        .htotal         = 720 + 120 + 20 + 120,   /* = Horizontal Active + HFPD + HSPW + HBPD (720 + 120 + 20 + 120) */

        .vdisplay       = 1280,                  /* = Vertical Active (1280) */
        .vsync_start    = 1280 + 30,                     /* = Vertical Active + VFPD (1280 + 60) */
        .vsync_end      = 1280 + 30 + 10,                /* = Vertical Active + VFPD + VSPW (1280 + 60 + 20) */
        .vtotal         = 1280 + 30 + 10 + 30,   /* = Vertical Active + VFPD + VSPW + VBPD (1280 + 60 + 20 + 60) */
...
static const struct ili9881c_desc davis_desc = {
	.init = legacy_davis_init,
	.init_length = ARRAY_SIZE(legacy_davis_init),
	.mode = &davis_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_SYNC_PULSE |
		      MIPI_DSI_MODE_LPM,
};
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "shaper,davis-panel", .data = &davis_desc },
